...
<tr>
  <td colspan="2" id="footer">
    ...
    <i18n:text key="poweredBy"/><xsl:text> </xsl:text><a href="http://yanel.org">Wyona Yanel</a> | <a href="http://github.com/wyona/tomcat-cluster/">Wyona Balancer</a> | <a href="http://tomcat.apache.org">Apache Tomcat</a> | <a href="http://httpd.apache.org">Apache HTTP Server</a><br/>
    Copyright &#169; 2021 <a href="http://www.wyona.com">Wyona</a>. <i18n:text key="allRightsReserved"/>. - <a href="?yanel.resource.meta"><i18n:text key="pageInfo"/></a> - <a href="?yanel.toolbar=on">Toolbar</a> - <a href="{$yarep.back2realm}my-profile.html">Do not track</a>: <xsl:value-of select="$do.not.track"/>
