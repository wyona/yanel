 ...
 */
package org.wyona.yanel.impl.resources.xmlsrcedit;
...
/**
 * Resource to edit XML source
 */
public class XMLSourceEditorResource extends ExecutableUsecaseResource {
    
    private static Logger log = Logger.getLogger(XMLSourceEditorResource.class);
