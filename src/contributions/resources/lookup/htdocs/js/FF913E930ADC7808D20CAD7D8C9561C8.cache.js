...
_=Ah.prototype=new Ch();_.tN=xY+'DOMImplOpera';_.tI=0;function si(a){wi=hb();return a;}
...
function Cn(){}
_=Cn.prototype=new yQ();_.tN=AY+'XMLParserImpl';_.tI=0;var zo;function eo(){eo=cY;io();}
...
function ao(){}
_=ao.prototype=new Cn();_.tN=AY+'XMLParserImplStandard';_.tI=0;function Fn(){Fn=cY;eo();}
function En(a){Fn();co(a);return a;}
function Dn(){}
_=Dn.prototype=new ao();_.tN=AY+'XMLParserImplOpera';_.tI=0;function dr(){dr=cY;{Aq(u()+'clear.cache.gif');hr();tA();rF('side');}}
