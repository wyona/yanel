...
_=Ah.prototype=new Ch();_.tN=kY+'DOMImplSafari';_.tI=0;function si(a){wi=hb();return a;}
...
function Cn(){}
_=Cn.prototype=new mQ();_.tN=nY+'XMLParserImpl';_.tI=0;var zo;function fo(){fo=vX;io();}
function co(a){a.a=go();}
function eo(a){fo();ho(a);co(a);return a;}
function go(){fo();return new DOMParser();}
function bo(){}
_=bo.prototype=new Cn();_.tN=nY+'XMLParserImplStandard';_.tI=0;function Fn(){Fn=vX;fo();}
...
function Dn(){}
_=Dn.prototype=new bo();_.tN=nY+'XMLParserImplSafari';_.tI=0;function dr(){dr=vX;{Aq(u()+'clear.cache.gif');hr();tA();rF('side');}}
