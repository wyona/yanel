...
_=Ah.prototype=new Ch();_.tN=yY+'DOMImplOpera';_.tI=0;function si(a){wi=hb();return a;}
...
function Cn(){}
_=Cn.prototype=new zQ();_.tN=BY+'XMLParserImpl';_.tI=0;var zo;function eo(){eo=dY;io();}
...
function ao(){}
_=ao.prototype=new Cn();_.tN=BY+'XMLParserImplStandard';_.tI=0;function Fn(){Fn=dY;eo();}
function En(a){Fn();co(a);return a;}
function Dn(){}
_=Dn.prototype=new ao();_.tN=BY+'XMLParserImplOpera';_.tI=0;function dr(){dr=dY;{Aq(u()+'clear.cache.gif');hr();uA();sF('side');}}
