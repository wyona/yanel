...
function gE(g,a,f){var b,c,d,e;e=wB(new vB());for(c=0;c<a.a;c++){xB(e,a[c].a);}b=false;for(c=0;c<a.a;c++){if(ov(a[c].a,f)){b=true;break;}}if(!b)xB(e,f);d=Ed('[Ljava.lang.String;',[0],[1],[e.a.b],null);for(c=0;c<d.a;c++){d[c]=de(zB(e,c),1);}return d;}
...
function tE(h){var a,b,c,d,e,f,g;if(h===this.e||h===this.g){g=lE(this);if(g!==null){if(h===this.e){a=kE(this,g);if(mj(this.e)){Bg('Add Read right from selected identity '+g+' from policy');e=gE(this,a,this.a);}else{Bg('Remove Read right from selected identity '+g+' from policy');e=oE(this,a,this.a);}sE(this,e);}else if(h===this.g){a=kE(this,g);if(mj(this.g)){Bg('Add Write right from selected identity '+g+' from policy');e=gE(this,a,this.b);}else{Bg('Remove Write right from selected identity '+g+' from policy');e=oE(this,a,this.b);}sE(this,e);}}else{Bg('No identity has been selected! Please select an identity in order to assign rights.');nj(this.e,false);nj(this.g,false);}}else if(h===this.c){g=lE(this);f=kE(this,g);b=false;c=false;for(d=0;d<f.a;d++){if(ov(f[d].a,this.a)){nj(this.e,true);b=true;}else if(ov(f[d].a,this.b)){nj(this.g,true);c=true;}}if(!b)nj(this.e,false);if(!c)nj(this.g,false);}}
function dE(){}
