...
function dE(g,a,f){var b,c,d,e;e=tB(new sB());for(c=0;c<a.a;c++){uB(e,a[c].a);}b=false;for(c=0;c<a.a;c++){if(lv(a[c].a,f)){b=true;break;}}if(!b)uB(e,f);d=Ed('[Ljava.lang.String;',[0],[1],[e.a.b],null);for(c=0;c<d.a;c++){d[c]=de(wB(e,c),1);}return d;}
...
function lE(f,a,e){var b,c,d;d=tB(new sB());for(b=0;b<a.a;b++){if(!lv(a[b].a,e)){uB(d,a[b].a);}}c=Ed('[Ljava.lang.String;',[0],[1],[d.a.b],null);for(b=0;b<c.a;b++){c[b]=de(wB(d,b),1);}return c;}
function mE(g,j,h,a){var b,c,d,e,f,i,k;Al(g.c);em(g.c,j);if(h!==null||a!==null){if(h!==null){for(b=0;b<h.a;b++){d='u: (';f=h[b].b;e=false;for(c=0;c<f.a;c++){if(lv(f[c].a,g.a)){e=true;break;}}if(e){d=d+g.a;}else{d=d+'-';}d=d+',';k=false;for(c=0;c<f.a;c++){if(f[c].eQ(g.b)){k=true;break;}}if(k){d=d+g.b;}else{d=d+'-';}d=d+') '+h[b].a;i='u: '+h[b].a;yl(g.c,d,i);}}if(a!==null){for(b=0;b<a.a;b++){d='g: (';f=a[b].b;e=false;for(c=0;c<f.a;c++){if(lv(f[c].a,g.a)){e=true;break;}}if(e){d=d+g.a;}else{d=d+'-';}d=d+',';k=false;for(c=0;c<f.a;c++){if(f[c].eQ(g.b)){k=true;break;}}if(k){d=d+g.b;}else{d=d+'-';}d=d+') '+a[b].a;i='g: '+a[b].a;yl(g.c,d,i);}}else{Bg('No groups!');}}else{xl(g.c,'No identities yet!');}}
...
function qE(h){var a,b,c,d,e,f,g;if(h===this.e||h===this.g){g=iE(this);if(g!==null){if(h===this.e){a=hE(this,g);if(gj(this.e)){Bg('Add Read right from selected identity '+g+' from policy');e=dE(this,a,this.a);}else{Bg('Remove Read right from selected identity '+g+' from policy');e=lE(this,a,this.a);}pE(this,e);}else if(h===this.g){a=hE(this,g);if(gj(this.g)){Bg('Add Write right from selected identity '+g+' from policy');e=dE(this,a,this.b);}else{Bg('Remove Write right from selected identity '+g+' from policy');e=lE(this,a,this.b);}pE(this,e);}}else{Bg('No identity has been selected! Please select an identity in order to assign rights.');hj(this.e,false);hj(this.g,false);}}else if(h===this.c){g=iE(this);f=hE(this,g);b=false;c=false;for(d=0;d<f.a;d++){if(lv(f[d].a,this.a)){hj(this.e,true);b=true;}else if(lv(f[d].a,this.b)){hj(this.g,true);c=true;}}if(!b)hj(this.e,false);if(!c)hj(this.g,false);}}
function aE(){}
